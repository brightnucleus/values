...
use BrightNucleus\Values\Value\IntegerValue as Testee;
...
final class IntegerValueTest extends TestCase
{
    ...
    const TEST_INTEGER = 42;
    const TEST_INTEGER_TO_ESCAPE = 42;
    const TEST_HTML_ESCAPED_STRING = '42';
    const TEST_ATTRIBUTE_ESCAPED_STRING = '42';
    const TEST_JS_ESCAPED_STRING = '42';
    ...
    {
        $this->assertInstanceOf(Testee::class, new Testee(self::TEST_INTEGER));
    }
    ...
    {
        $this->assertTrue(Testee::isValid(self::TEST_INTEGER));
    }
    ...
    {
        $object = new Testee(self::TEST_INTEGER);
        $this->assertEquals(self::TEST_INTEGER, $object->validate(self::TEST_INTEGER));
    }
    ...
    {
        $object = new Testee(self::TEST_INTEGER_TO_ESCAPE);
    ...
    {
        $object = new Testee(self::TEST_INTEGER);
        $this->assertEquals(self::TEST_INTEGER, $object->getValue());
    }
    ...
    {
        $object = new Testee(self::TEST_INTEGER_TO_ESCAPE);
        $this->assertEquals(self::TEST_INTEGER_TO_ESCAPE, $object->getValue());
    }
    ...
    public function it_can_have_its_value_changed()
    {
        $object = new Testee(self::TEST_INTEGER_TO_ESCAPE);
        $this->assertEquals(self::TEST_INTEGER_TO_ESCAPE, $object->getValue());
        $object->setValue(self::TEST_INTEGER);
        $this->assertEquals(self::TEST_INTEGER, $object->getValue());
    }
    ...
    {
        $object = new Testee(self::TEST_INTEGER, Value::CAN_BE_EMPTY);
        $object->setValue('');
        $this->assertTrue($object->isEmpty());
    }
    ...
    {
        $object1 = new Testee(self::TEST_INTEGER);
        $object2 = new Testee(self::TEST_INTEGER, Value::CAN_BE_EMPTY);
