...
use BrightNucleus\Values\Value\EmailAddressValue as Testee;
 ...
 * @author  Alain Schlesser <alain.schlesser@gmail.com>
 */
final class EmailAddressValueTest extends TestCase
{

    const TEST_EMAIL_ADDRESS = 'alain.schlesser+test_value@gmail.com';
    const TEST_EMAIL_ADDRESS_TO_ESCAPE = 'alain.schlesser+test_value@gmail.com';
    const TEST_HTML_ESCAPED_STRING = 'alain.schlesser+test_value@gmail.com';
    const TEST_ATTRIBUTE_ESCAPED_STRING = 'alain.schlesser+test_value@gmail.com';
    const TEST_JS_ESCAPED_STRING = 'alain.schlesser+test_value@gmail.com';
    ...
    {
        $this->assertInstanceOf(Testee::class, new Testee(self::TEST_EMAIL_ADDRESS));
    }
    ...
    {
        $this->assertTrue(Testee::isValid(self::TEST_EMAIL_ADDRESS));
    }
    ...
    public function it_can_identify_invalid_values()
    {
        ...
        $this->assertFalse(Testee::isValid('random string'));
    }
    ...
    {
        $object = new Testee(self::TEST_EMAIL_ADDRESS);
        $this->assertEquals(self::TEST_EMAIL_ADDRESS, $object->validate(self::TEST_EMAIL_ADDRESS));
    }
    ...
    {
        $object = new Testee(self::TEST_EMAIL_ADDRESS_TO_ESCAPE);
    ...
    {
        $object = new Testee(self::TEST_EMAIL_ADDRESS);
        $this->assertEquals(self::TEST_EMAIL_ADDRESS, $object->getValue());
    }
    ...
    {
        $object = new Testee(self::TEST_EMAIL_ADDRESS_TO_ESCAPE);
        $this->assertEquals(self::TEST_EMAIL_ADDRESS_TO_ESCAPE, $object->getValue());
    }
    ...
    public function it_can_have_its_value_changed()
    {
        $object = new Testee(self::TEST_EMAIL_ADDRESS_TO_ESCAPE);
        $this->assertEquals(self::TEST_EMAIL_ADDRESS_TO_ESCAPE, $object->getValue());
        $object->setValue(self::TEST_EMAIL_ADDRESS);
        $this->assertEquals(self::TEST_EMAIL_ADDRESS, $object->getValue());
    }
    ...
    {
        $object = new Testee(self::TEST_EMAIL_ADDRESS, Value::CAN_BE_EMPTY);
        $object->setValue('');
        $this->assertTrue($object->isEmpty());
    }
    ...
    {
        $object1 = new Testee(self::TEST_EMAIL_ADDRESS);
        $object2 = new Testee(self::TEST_EMAIL_ADDRESS, Value::CAN_BE_EMPTY);
